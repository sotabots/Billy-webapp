...
export const Tabs = ({ items, className, children }: {
  items: {
    title: string
    isActive: boolean
  ...
  <div className={cx(
    ...
    {items.map((tab, i) => (
      <button
        key={i}
        className={cx(
          'flex flex-grow basis-0 items-center justify-center gap-1 h-[32px] border-b text-[14px] leading-[0.9em] transition-all',
          !tab.isActive
